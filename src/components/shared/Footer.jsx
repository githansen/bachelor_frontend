		...
		<div className='bg-dark text-white mt-20 pt-5'>
			<div className="flex justify-between m-16 mb-0 max-w-screen-xl mx-auto">
				<div className='grid content-between'>
					<div className='mb-10'>
						<img src={GiDinStemmeIconNoBg} className='w-[4rem] mb-2'></img>
				...
				<div className='grid content-between'>
					<div className='mt-10'>
						...
						<ul className='text-gray-60 mt-3'>
							<li>
								<NavLink to="/om-oss" className="text-p hover:text-white transition duration-150 ease-in-out">
									Hva er gi din stemme?
								</NavLink>
							</li>
							<li>
								<NavLink to="/slett" className="text-p hover:text-white transition duration-150 ease-in-out">
									Slett ditt bidrag
								</NavLink>
							</li>
							<li>
								<NavLink to="/personvern" className="text-p hover:text-white transition duration-150 ease-in-out">
									Personvern
								</NavLink>
							</li>
						</ul>
