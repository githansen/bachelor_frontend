        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="min-h-[calc(100vh-500px)] flex flex-col place-items-center my-[10rem]">
            ...
            <button
              ...
              className="transScale text-dark bg-secondary px-4 py-4 mb-2 font-bold text-h4 mt-2 text-black w-48 rounded inline-flex justify-center items-center gap-2"
            >
              Gå videre
              <svg
            ...
            <div className="max-w-md text-gray-300 italic mt-5 text-center">
              <p className="text-p">
                Vi samler ikke inn noen personlige data fra deg, denne infoen
                blir kun brukt til å systematisere data.
              </p>
            </div>
          </div>
        </div>
