            ...
            <div className='mx-auto max-w-screen-xl w-full'>
			    <div className="min-h-[50rem] flex flex-col place-items-center justify-center">
                    ...
                    <p className='text-p mb-5 sm:max-w-2xl text-center'>
                        Om du ønsker å slette ditt bidrag må du fylle inn feltet under. Vi har ikke samlet inn noe av din info, og det er derfor kun mulig
                        å slette ditt bidrag om du har din bidragskode.
                    </p>
                    <form className='flex flex-col place-items-center justify-center mb-20'>
                        <div class="mb-4">
                            <input class="border-2 w-[20rem] text-center placeholder-orange-200 border-secondary bg-secondary-soft p-3 rounded-lg text-orange-600 font-bold leading-tight focus:outline-none focus:shadow-outline" id="bidragskode" type="text" placeholder="123E4567-E89B-12D30-EG94348" />
                        </div>
                ...
                <Dialog.Panel className="w-full max-w-md text-center transform overflow-hidden rounded-lg bg-white p-14 align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-p text-gray-500">
                      Denne endringen kan ikke tilbakestilles.
                    </p>
                  </div>
