        ...
        <Layout>
            <div className="xs:mx-14 sm:mx-14 lg:mx-auto lg:max-w-6xl">
                <div className="min-h-[20rem] md:min-h-[40rem] lg:min-h-[50rem] xs:my-8 sm:my-10 md:my-12 lg:my-14px xl:my-14 flex flex-col place-items-center justify-center gap-5">
                    <img 
                        src={FourOFourIcon}
                        className="xs:h-[18rem] sm:h-[20rem] md:h-[22rem] lg:h-[25rem] xl:h-[27rem] mb-2 object-contain"
                    ></img>
                    ...
                    <h4 className="xs:text-xsh4 sm:text-smh4 md:text-mdh4 lg:text-lgh4 xl:text-xlh4 text-h4 mb-5 text-center">
